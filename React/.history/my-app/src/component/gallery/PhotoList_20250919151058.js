...
const PhotoItem = ({ info: { url } }) => {
  return (
    <div className="relative h-[300px] cursor-pointer">
      ...
      <button className="absolute p-4 px-6 py-2 text-sm font-medium text-black bg-white rounded-lg opacity-0 cursor-pointer bottom-5 left-2/4 -translate-x-2/4 in">
        Add to cart
      </button>
    </div>
  );
