...
const PhotoItem = ({ info: { url, isFavorite, id } }) => {
  ...
  return (
    <div className="relative h-[300px] cursor-pointer group">
      ...
      <span className="absolute z-10 w-8 transition-all opacity-0 cursor-pointer right-5 top-5 group-hover:opacity-100 group-hover:visible" onClick = {() => toggleFavorite(id)}>
        <svg
          width="42"
          height="38"
          viewBox="0 0 42 38"
