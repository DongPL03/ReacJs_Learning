  ...
  return (
    <ModalBase {...props}>
      <div className="modal-content bg-white z-10 relative p-10 rounded-lg w-full max-w-[482px]">
          <span className="absolute top-0 right-0 flex items-center justify-center w-10 h-10 p-1 bg-white rounded-full cursor-pointer -translate-y-2/4 translate-x-2/4" onClick={() => setOpenModal(false)}>
            <svg
              width="14"
              height="14"
              viewBox="0 0 14 14"
