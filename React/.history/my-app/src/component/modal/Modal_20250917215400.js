    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center modal">
      ...
      <div className="modal-content bg-white z-10 relative p-10 rounded-lg w-full max-w-[482px]">
        ...
        <div className="flex flex-col gap-3 mb-5">
         ...
         <div className="flex flex-col gap-3 mb-5">
            <label htmlFor="password" className="text-sm cursor-pointer">Email address</label>
            <input type="password" name="" id="" placeholder="Enter your email" className="w-full text-sm leading-normal bg-[#e7ecf3] rounded-lg p-4"/>
        </div>
      </div>
    </div>,
